...
=== GPIO usage and pin headers

Raspberry Pi audio boards take advantage of a number of Raspberry Pi signals to operate. Some of these signals are solely for the use of the board, and
...
The DAC PRO, DAC{plus} and DigiAMP{plus} re-expose the Raspberry Pi signals, allowing additional sensors etc.
